package com.example.activiti.workflow.command;
...
import com.example.activiti.utils.SpringContextKit;
 ...
 */
public class JumpToTaskNode implements Command<Void> {
...
//    private final String targetNodeId;
    ...
    private final String targetTaskId;//跳转的目标taskId
     ...
     */
    public JumpToTaskNode(String taskId, String targetTaskId, Map<String, Object> variables, String comment) {
        this.taskId = taskId;
     ...
     * @param variables 流转数据
     */
    public JumpToTaskNode(String taskId, String targetTaskId, String assignee, Map<String, Object> variables, String comment) {
        this.taskId = taskId;
        this.targetTaskId = targetTaskId;
...
//        Process process = ProcessDefinitionUtil.getProcess(processDefinitionId);
        ...
        FlowElement flowElement = process.getFlowElement(this.targetTaskId);
